...
export default function Output({conVenience,feedBack}) {
  ...
  return (
    <div className=' flex w-[300px] gap-2 mx-3 my-4'>
        <div className="icon">
        ...
        <div className="rest flex flex-col w-[75%] ">
            <div className="up flex relative ">
                <div className="text _Orange  rounded-[10px] p-2 ">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Odio, inventore.
                </div>
                <div className="sound ">
                <img src={process.env.PUBLIC_URL + '/Read Aloud.png'} alt="Error loading image" className='w-[50px] ' />
                </div>
            </div>
            <div className="down flex justify-between">
                ...
                <div className="like-dislike flex">
                    ...
                    <div className="dislike ">
                      <img src={process.env.PUBLIC_URL + 'dislike.png'} alt="Error loading image" className='w-[14px] 'onClick={conVenience} />
                    </div>
                </div>
            </div>
        </div>
